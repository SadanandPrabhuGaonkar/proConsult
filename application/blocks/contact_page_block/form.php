...
<div class="form-group">
    <?php echo $form->label($view->field('contentArea'), t("Content area")); ?>
    <?php echo isset($btFieldsRequired) && in_array('contentArea', $btFieldsRequired) ? '<small class="required">' . t('Required') . '</small>' : null; ?>
    <?php echo Core::make('editor')->outputBlockEditModeEditor($view->field('contentArea'), $contentArea); ?>
</div>
...
<script type="text/javascript">
    Concrete.event.publish('contact_page_block.stack.stacks');
</script>
